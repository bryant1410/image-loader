# image-loader [![](http://ci.novoda.com/buildStatus/icon?job=ImageLoader)](http://ci.novoda.com/job/ImageLoader/lastSuccessfulBuild/console) [![](https://raw.githubusercontent.com/novoda/novoda/master/assets/btn_apache_lisence.png)](LICENSE.txt)
